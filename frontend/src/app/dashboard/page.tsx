...
export default function DashboardPage() {
  ...
  if (!dashboardData) {
    return (
      <PageContainer>
        <ContentArea>
          <div className="flex flex-col items-center justify-center h-full text-center p-8 bg-white/70 rounded-3xl border border-white/80 min-h-[400px]">
      ...
      <ContentArea>
        <DashboardShell>
          ...
          <div className={`${DASHBOARD_CONSTANTS.layout.leftColSpan} flex flex-col gap-5`}>
            <WelcomeHero streak={data.stats?.currentStreak || 0} />
