...
export default function LoginPage() {
  ...
  const loginFeatures = [
    { icon: BrainCircuit, title: "AI Mentor", subtitle: "Personalized guidance" },
    { icon: BookOpen, title: "Adaptive Learning", subtitle: "Learns your pace" },
    { icon: Zap, title: "Concept Mastery", subtitle: "Understand deeply" },
    { icon: MessageSquare, title: "Instant Feedback", subtitle: "Improve continuously" },
  ];
  ...
  return (
    <div className="flex w-full h-[100dvh] overflow-hidden bg-[#F8F9FF] selection:bg-[#6C5CE7]/20 text-[#1B1D35] font-sans relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <motion.div 
          animate={{ x: [0, 50, -100, 0], y: [0, -80, 50, 0], scale: [1, 1.2, 1] }}
          transition={{ duration: 22, repeat: Infinity, ease: "easeInOut" }}
          className="absolute -bottom-[20%] left-[20%] w-[50vw] h-[50vw] rounded-full bg-[#BFFFF0] blur-[120px] opacity-30 mix-blend-multiply z-0" 
        />
      </div>
        ...
        <div className="hidden md:flex flex-col w-[50%] h-full relative justify-center px-10 lg:px-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-[480px]">
            ...
            <motion.h2 
              ...
              className="text-[24px] lg:text-[28px] font-normal tracking-tight text-[#6C5CE7] mb-6 drop-shadow-sm"
            >
            ...
            <motion.p 
              ...
              className="text-[#6B7280] text-[17px] leading-relaxed max-w-[400px] mb-12"
            >
              Pick up exactly where you left off. Your AI companion is ready to guide your next learning session.
            </motion.p>
        ...
        <div className="flex flex-col w-full md:w-[50%] h-full relative items-center justify-center p-6 z-20">
          ...
          >
            ...
            <div className="md:hidden flex flex-col mb-6">
              <h1 className="text-[28px] font-medium tracking-tight text-[#1B1D35] mb-1">Welcome back.</h1>
              <p className="text-[#6C5CE7] text-[16px] mb-2">Continue understanding.</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full h-[52px] bg-white/80 backdrop-blur-md border rounded-[18px] px-5 text-[15px] outline-none transition-all duration-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.015)] hover:bg-white hover:border-[#A29BFE]/60 focus:bg-white focus:border-[#6C5CE7] focus:ring-[3px] focus:ring-[#6C5CE7]/15 placeholder:text-[#6B7280]/40 ${errors.email ? "border-[#FC8181] focus:border-[#E53E3E] focus:ring-[#E53E3E]/15" : "border-[#E2E8F0]"}`}
                    {...register("email")}
                  />
                </div>
                <AnimatePresence>
                  {errors.email && (
                    <motion.p initial={{ opacity: 0, height: 0, y: -5 }} animate={{ opacity: 1, height: "auto", y: 0 }} exit={{ opacity: 0, height: 0 }} className="text-[13px] text-[#E53E3E] font-medium mt-1 ml-1">
              ...
              <div className="flex flex-col gap-1.5">
                <div className="flex items-center justify-between ml-1">
                  <label htmlFor="password" className="text-[13px] font-semibold text-[#1B1D35] uppercase tracking-wider opacity-80">
                    Password
                  </label>
                  <Link href={ROUTES.FORGOT_PASSWORD} className="text-[13px] text-[#6C5CE7] hover:text-[#8B7CF6] cursor-pointer transition-colors font-medium">
                    Forgot?
                  </Link>
                </div>
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full h-[52px] bg-white/80 backdrop-blur-md border rounded-[18px] px-5 pr-12 text-[15px] outline-none transition-all duration-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.015)] hover:bg-white hover:border-[#A29BFE]/60 focus:bg-white focus:border-[#6C5CE7] focus:ring-[3px] focus:ring-[#6C5CE7]/15 placeholder:text-[#6B7280]/40 ${errors.password ? "border-[#FC8181] focus:border-[#E53E3E] focus:ring-[#E53E3E]/15" : "border-[#E2E8F0]"}`}
                    {...register("password")}
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-4 top-[14px] text-[#A0AEC0] hover:text-[#1B1D35] transition-colors p-1 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6C5CE7]/30"
              ...
              <div className="mt-2 relative group">
                ...
                <motion.button 
                  ...
                  className="w-full h-[56px] relative rounded-[18px] bg-gradient-to-b from-[#7F71F5] to-[#6C5CE7] text-white font-medium text-[16px] tracking-wide shadow-[inset_0_1px_1px_rgba(255,255,255,0.3),0_4px_10px_rgba(108,92,231,0.2)] overflow-hidden flex items-center justify-center border-none disabled:opacity-80 disabled:cursor-not-allowed"
                >
            ...
            <div className="mt-8 pt-6 border-t border-[rgba(108,92,231,0.08)] text-center text-[14px] text-[#718096] font-medium">
              Don&apos;t have an account?{" "}
              <Link href={ROUTES.REGISTER} className="font-semibold text-[#1B1D35] relative group inline-block ml-1">
                <span className="relative z-10 hover:text-[#6C5CE7] transition-colors duration-200">Sign up</span>
