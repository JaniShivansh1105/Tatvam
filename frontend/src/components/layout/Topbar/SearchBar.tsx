  ...
  return (
    <div className="hidden md:flex relative group w-full max-w-[400px]">
      ...
      <input
        ...
        className="w-full h-11 bg-white/50 backdrop-blur-md border border-[rgba(108,92,231,0.1)] rounded-full pl-11 pr-4 text-[14px] text-[#1B1D35] placeholder:text-[#A0AEC0] outline-none transition-all duration-300 hover:bg-white/80 hover:border-[rgba(108,92,231,0.2)] focus:bg-white focus:border-[#6C5CE7] focus:ring-[3px] focus:ring-[#6C5CE7]/15 shadow-sm"
      />
    </div>
  );
}
